...
def get_document(collection: Collection, elements: dict):
    """ Function to retrieve single documents from a provided
    Collection using a dictionary containing a document's elements. """
    return collection.find_one(elements)


def get_documents(collection: Collection, elements: dict) -> list:
    """ Function to retrieve multiple documents from a provided
        Collection using a dictionary containing a document's elements. """
    return [doc for doc in collection.find(elements)]
